...
CREATE TABLE IF NOT EXISTS products (
  ...
  game TEXT NOT NULL, -- หมวดหมู่หลัก
  subcategory TEXT, -- หมวดหมู่ย่อย (ไม่บังคับ) เช่น "ของแต่งตัว", "บัตรเติมเงิน"
  description TEXT,
...
-- แบนเนอร์โปรโมชันหน้าแรก (เลื่อนสลับกันได้หลายอัน)
...
-- ข้อมูลติดต่อร้าน (แก้ไขได้จากหน้าแอดมิน)
...
// ---------- Migration: เพิ่มคอลัมน์ subcategory ให้ฐานข้อมูลเก่าที่สร้างไว้ก่อนฟีเจอร์นี้ ----------
const productColumns = db.prepare("PRAGMA table_info(products)").all();
if (!productColumns.some(c => c.name === 'subcategory')) {
